...
export class BabylonService {
  ...
  public createScene(canvas: ElementRef<HTMLCanvasElement>): void {
    ...
    this.camera = new BABYLON.ArcRotateCamera("Camera", 0, 0, 0.1, new BABYLON.Vector3(0, 0, 0), this.scene);
    ...
    // Boxes
    //var box1 = BABYLON.Mesh.CreateBox("Box1", 1.0, this.scene);
    //box1.position.x = -1;
    //var box2 = BABYLON.Mesh.CreateBox("Box2", 1.0, this.scene);
